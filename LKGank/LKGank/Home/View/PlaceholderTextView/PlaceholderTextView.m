...
//                                                               , CGRectGetWidth(self.frame)-2*left, hegiht)];
    PlaceholderLabel=[[UILabel alloc] initWithFrame:CGRectMake(5, 0 , self.frame.size.width-10, self.frame.size.height-10)];
    PlaceholderLabel.contentMode=UIViewContentModeTop;
    PlaceholderLabel.textColor=[UIColor colorWithRed:155/255.0 green:156/255.0 blue:157/255.0 alpha:1.0];
